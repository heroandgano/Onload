...
class ReadBakeryComponent extends Component {
    ...
    handlePayment = () => {
        ...
        const apiUrl = `http://3.34.181.27/payment/ready`;
                ...
                <div className="row">
                    <div className="card offset-md-2 col-md-6" style={{ marginRight: "20px;" }}>
                        <div className="card-body">
                            <div className="card">
                                <div className="card-body">
                                    <img id="bakeryImg" src={`http://3.34.181.27/api/comunity/images/${this.state.bakery.mainphoto}`} />
                                    <hr />
                                                ...
                                                <div key={index} className="col-md-4">
                                                    <Card style={{ margin: "0 10px", width: "300px", height: "200px" }}>
                                                        <Card.Img
                                                            id={`bakeryImg${index}`}
                                                            variant="top"
                                                            src={`http://3.34.181.27/api/comunity/images/${photoname}`}
                                                        />
                                                    </Card>
                                                </div>
                                            ))}
