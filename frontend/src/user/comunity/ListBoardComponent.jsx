...
import { Button, Pagination, PaginationItem, PaginationLink } from "@mui/material";
                            ...
                            >
                                {comunity.attachedFiles.length > 0 ? (
                                    <img
                                        ...
                                        src={`http://3.34.181.27/api/comunity/images/${comunity.attachedFiles[0].storeFilename}`}
                                        alt={`file_0`}
                                        style={{ height: "200px" }}
                                    />
                                ) : (
